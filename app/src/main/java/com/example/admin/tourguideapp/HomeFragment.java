...
public class HomeFragment extends Fragment {
    ...
    public void tourGuideData() {
        stringArrayList.add(new Tour(R.drawable.lamu, getString(R.string.lamu)));
        stringArrayList.add(new Tour(R.drawable.shella, getString(R.string.shela)));
        stringArrayList.add(new Tour(R.drawable.matondoni, getString(R.string.matondoni)));
